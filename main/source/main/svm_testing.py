...
best_svc = SVC(C=2.1, gamma=0.00001, degree=2, kernel='linear')
best_svc.fit(x_train, y_train)
svc_predictions = best_svc.predict(x_test)

joblib.dump(best_svc, 'D:\\group_projects\\Sign-machine-learning\\main\\source\\models\\svm_3_linear.joblib')
